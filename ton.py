...
cl = LINETCR.LINE()
cl.login(token="EqhfM5FDoyvne3tjeIk2.xmmq9uFE/yrnR9W8fD5FqG.g/9BhjFAgb+jWpFlZpycosDTZlMm7rnnikY4B5zYdjk=")
cl.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u5cc310f547def9844dafdc3c15de5f42",mid]
self = ["u5cc310f547def9844dafdc3c15de5f42",mid]
admin = "u5cc310f547def9844dafdc3c15de5f42"
admsa = "u5cc310f547def9844dafdc3c15de5f42"
owner = "u5cc310f547def9844dafdc3c15de5f42"
adminMID = "u5cc310f547def9844dafdc3c15de5f42"
Creator="u5cc310f547def9844dafdc3c15de5f42"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
...
#========================================
            ...
            elif 'บินแม่ง' in msg.text:
                if msg.toType == 2:
                    print "Kickall ok"
                    _name = msg.text.replace("บินแม่ง","")
                    ...
                    ki1.sendText(msg.to, "พร้อมจุกยัง บินละนะ...😁😁 {}")
                    targets = []
                    for g in gs.members:
...
#==============================================================================#
                ...
                cl.sendText(msg.to,"-- List Groups --\n\n"+ h +"\nTotal groups =" +" ["+str(len(gid))+"]")
            ...
            elif msg.text in ["tag","Tag","แทก","มาแล้วจร้า"]:
                 group = cl.getGroup(msg.to)
                 ...
                 cnt = Message()
                 cnt.text = "สมาชิกทั้งหมด 👉 : " + str(jml) +  " คน"
                 cnt.to = msg.to
                 cl.sendMessage(cnt)
