...
cl = LINETCR.LINE()
cl.login(token="EqeVVMBukbATqQ4ZhPrf.SxIX7PxQF/ZK2D6Pb2ntdW.efFt2zihcOEDxSKkEECLzZuPJZisd8CdeIce3H8IkSs=")
cl.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["ub178b1ee95ea7fece4d9dea90763530f",mid]
self = ["ub178b1ee95ea7fece4d9dea90763530f",mid]
admin = "ub178b1ee95ea7fece4d9dea90763530f"
admsa = "ub178b1ee95ea7fece4d9dea90763530f"
owner = "ub178b1ee95ea7fece4d9dea90763530f"
adminMID = "ub178b1ee95ea7fece4d9dea90763530f"
Creator="ub178b1ee95ea7fece4d9dea90763530f"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
